...
public class Player extends Entity {
    ...
    public Player(GamePanel gp, KeyManager keyM) {
        ...
        solidArea = new Rectangle(50, 50, 64, 32);
    ...
    public void setDefaultValues() {
        x = gp.tileSize * 10;
        y = gp.tileSize * 4;
        speed = 9; //nr de pixeli distanta la apasarea unei taste de miscare
        direction = "down";
    ...
    public void update() {
        ...
        if (keyM.upPressed == true || keyM.downPressed == true || keyM.leftPressed == true || keyM.rightPressed == true) {
            ...
            if (keyM.downPressed == true) {
                direction = "down";
                //gp.ui.showMassage("You go down just like BLO ODY Mary");
            }
            ...
            //Verifica coliziunea cu tile si npc
            collisionOn = false;
